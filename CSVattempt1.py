...
#all_messages is a dictionary with one key/value pair -- "messages": [list of dictionaries containing, threadId, and their corresponding values]
all_messages = GMAIL.users().messages().list(userId='me').execute()

#mssg_list is a list with each element a dictionary of id, threadId, and their corresponding values
